...
| TECH_5G_SA_CNT | NR station count (station-side NR/SA proxy; renamed from `ERB_NR`) | Integer | RQ1 target construction |
| HIGH_SA_P75 | 1 if TECH_5G_SA_CNT > 9 (75th percentile); P70 = 6 and P80 = 12 used for sensitivity | Binary | RQ1 target |
